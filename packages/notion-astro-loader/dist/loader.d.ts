 ...
 * });
 */
export declare function notionLoader({ saveImagesAsStrings, database_id, filter_properties, sorts, filter, archived, rehypePlugins, ...clientOptions }: NotionLoaderOptions): Loader;
